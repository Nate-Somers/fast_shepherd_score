...
def coarse_fine_vol_color_tversky_align_many(
    ...
    # INHERITED CONSTANT, NOT MEASURED: this 3e7 was copied from vol_color. vol_color_tversky
    # was never run in the graph-budget campaign (jobs 22637452 / 22637626 covered vol_color,
    # vol_lipo, pharm and vol_and_surf_esp only), and the screen cannot reach it -- the store
    # reports supports=False for this mode (job 22637463). Do not read the number as a decision.
